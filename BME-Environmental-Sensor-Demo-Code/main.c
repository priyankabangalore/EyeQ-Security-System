/*
  ...
  This code is copyrighted: Copyright (C) 2016 - 2017 Bosch Sensortec GmbH
*/
#include "bme280.h"
#include <stdio.h>
#include <unistd.h>
...
/*!
 \fn DisplayUI
 * Modified from original code obtained from https://www.waveshare.com/wiki/BME280_Environmental_Sensor. The original version used printf and
 * to print the string to the console. The updated version prints the string to a text file to be read by the website. 
 @brief Outputs weather reading to a .txt file.
 The print_sensor_data method parses the weather information obtained from the weather sensor into a textfile to be read on the front-end.
 @param comp_data Weather sensor data
 @author Ian Ginson
*/
void print_sensor_data(struct bme280_data *comp_data)
  // Open a file
  FILE *ftemp;
  ftemp = fopen("weathers.txt", "w");
  if (ftemp == NULL) {
...
#else
	fprintf("temperature:%ld*C   pressure:%ldhPa   humidity:%ld%%\r\n",comp_data->temperature, comp_data->pressure/100, comp_data->humidity);
#endif
